...
namespace grynca {
    ...
    class Vec2 {
        ...
        friend bool isOnSegment(const Vec2& p, const Vec2& start, const Vec2& end, f32 eps = 0.01f);
        friend bool isOnLine(const Vec2& p, const Vec2& start, const Vec2& end, f32 eps = 0.01f);
        friend bool isRightFromLine(const Vec2& p, const Vec2& start, const Vec2& end, f32 eps = 0.01f);
        friend bool isLeftFromLine(const Vec2& p, const Vec2& start, const Vec2& end, f32 eps = 0.01f);
